  ...
  return (
    <div id={`slide${slideNumber}`} className="carousel-item relative w-full">
      <div className="flex flex-col items-center justify-center mx-auto gap-2 px-[15%]">
        <img
          src={image}
          className="w-32 sm:w-44 rounded-full border-2 border-gray-400"
        />
        <p className="text-sm w-[90%] sm:w-full sm:text-xl text-gray-200 text-center">
          {description}
        </p>
        <h3 className="text-xl sm:text-2xl font-semibold text-yellow-500">
          {title}
        </h3>
